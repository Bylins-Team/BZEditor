// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VerticalScrollBar.cs" company="RAbit">
//   Copyright 2009 All Rights Reserved
// </copyright>
// <author>Alexander Dolgof</author>
// <email>dolgof@gmail.com</email>
// <summary>
//   Реализует вертикальную полосу прокрутки.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace BZEditor
{
    ...
    /// <summary>
    /// Реализует ректикальную полосу прокрутки.
    /// </summary>
    public class VerticalScrollBar : VScrollBar
    {
